...
const AboutUs = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative h-[70vh] flex items-center justify-center bg-hymid-light overflow-hidden">
        <div className="absolute inset-0 z-0">
          <div 
            className="absolute inset-0 bg-cover bg-center"
            style={{ 
              backgroundImage: 'url(https://images.unsplash.com/photo-1581095566331-1525ca2fcd25?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80)',
        ...
        <div className="hymid-container">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-hymid-dark mb-4">
              Our <span className="text-hymid-teal">Company</span>
            </h2>
          </div>
          ...
          <div className="flex flex-col md:flex-row items-center gap-16">
              ...
              <div className="relative">
                <div className="reveal-on-scroll bg-hymid-light p-8 rounded-lg shadow-lg">
                  <p className="text-hymid-gray mb-6">
                    Founded in 2002, STC is a leading MSME manufacturing enterprise focused on delivering precision plastic solutions for diverse industries. We combine technical excellence with innovative design thinking to create high-quality products that meet our clients' exact specifications.
                  </p>
                  <p className="text-hymid-gray mb-6">
                    Our state-of-the-art facility spanning over 25,000 sq. ft. is equipped with advanced machinery and staffed by skilled professionals who are passionate about manufacturing excellence.
                  </p>
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-hymid-teal rounded-full mr-2"></div>
                      <span className="text-hymid-dark">ISO 9001:2015</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-hymid-teal rounded-full mr-2"></div>
                      <span className="text-hymid-dark">20+ Years Experience</span>
                    </div>
                    <div className="flex items-center">
                      <div className="w-2 h-2 bg-hymid-teal rounded-full mr-2"></div>
            ...
            <div className="w-full md:w-1/2">
              ...
              <div className="mt-8 reveal-on-scroll">
                <div className="bg-hymid-light p-6 rounded-lg shadow-md">
                  <h3 className="text-xl font-semibold text-hymid-dark mb-4">Our Mission</h3>
                  <p className="text-hymid-gray">
                    To deliver exceptional plastic manufacturing solutions that exceed client expectations through innovation, quality, and sustainable practices.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="hymid-container">
          <div className="text-center mb-16">
            ...
            <p className="text-hymid-gray max-w-3xl mx-auto">
              Our talented team brings together decades of experience in plastic manufacturing, engineering, and design.
            </p>
          </div>
      ...
      <section id="process-about" className="section-padding bg-white">
        <div className="hymid-container">
          <div className="text-center mb-16">
            ...
            <p className="text-hymid-gray max-w-3xl mx-auto">
              We follow a meticulous process to transform your ideas into high-quality plastic products.
            </p>
          </div>
            ...
            <div className="space-y-16">
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 mb-8 md:mb-0 reveal-on-scroll text-right">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-xl font-semibold text-hymid-dark mb-3">Consultation & Requirements</h3>
                    <p className="text-hymid-gray">
                      We begin with a thorough consultation to understand your product requirements, specifications, and application needs.
                    </p>
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row-reverse items-center">
                <div className="md:w-1/2 md:pl-12 mb-8 md:mb-0 reveal-on-scroll">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-xl font-semibold text-hymid-dark mb-3">Design & Engineering</h3>
                    <p className="text-hymid-gray">
                      Our engineering team creates detailed designs and prototypes, considering material properties, functionality, and aesthetics.
                    </p>
                  </div>
                </div>
                <div className="hidden md:block w-8 h-8 bg-hymid-teal rounded-full relative z-10 mx-auto"></div>
              ...
              <div className="flex flex-col md:flex-row items-center">
                <div className="md:w-1/2 md:pr-12 mb-8 md:mb-0 reveal-on-scroll text-right">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-xl font-semibold text-hymid-dark mb-3">Production & Quality Control</h3>
                    <p className="text-hymid-gray">
              ...
              <div className="flex flex-col md:flex-row-reverse items-center">
                <div className="md:w-1/2 md:pl-12 mb-8 md:mb-0 reveal-on-scroll">
                  <div className="bg-white p-6 rounded-lg shadow-md">
                    <h3 className="text-xl font-semibold text-hymid-dark mb-3">Delivery & Support</h3>
                    <p className="text-hymid-gray">
                      We ensure timely delivery of your products and provide ongoing support to address any concerns or future requirements.
                    </p>
                  </div>
                </div>
                <div className="hidden md:block w-8 h-8 bg-hymid-teal rounded-full relative z-10 mx-auto"></div>
        ...
        <div className="hymid-container">
          ...
          <div className="mt-16 reveal-on-scroll">
            <div className="bg-white p-8 rounded-lg shadow-lg">
              <h3 className="text-2xl font-semibold text-hymid-dark mb-6 text-center">Client Testimonials</h3>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-hymid-light p-6 rounded-lg">
                  <p className="italic text-hymid-gray mb-4">
                    "STC has consistently delivered high-quality plastic components for our automotive applications. Their attention to detail and commitment to meeting deadlines make them a valuable partner."
                  </p>
                  <p className="font-semibold text-hymid-dark">- Automotive Industry Client</p>
                </div>
                <div className="bg-hymid-light p-6 rounded-lg">
                  <p className="italic text-hymid-gray mb-4">
                    "We've been working with STC for over 5 years, and they continue to impress us with their innovative approach to plastic manufacturing and excellent customer service."
                  </p>
                  <p className="font-semibold text-hymid-dark">- Healthcare Sector Client</p>
                </div>
              </div>
            </div>
          </div>
