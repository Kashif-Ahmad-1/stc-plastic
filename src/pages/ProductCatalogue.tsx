...
const ProductCard = ({ product, index }) => {
  return (
    ...
    >
      ...
      <div className="p-6">
        <h3 className="text-xl font-semibold text-hymid-dark mb-2">
          {product.name}
        </h3>
        <p className="text-hymid-gray mb-4 line-clamp-2">
          {product.description}
        </p>
        ...
        <div className="p-4 bg-white">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {products.map((product, index) => (
              <div
                key={index}
                className="border border-gray-200 p-4 rounded-md hover:border-hymid-teal transition-colors"
              >
                <div className="flex items-center mb-2">
                  ...
                  <h4 className="font-medium text-hymid-dark">
                    {product.name}
                  </h4>
                </div>
                <p className="text-sm text-hymid-gray mb-3 line-clamp-2">
                  {product.description}
                </p>
                <a href="#" className="text-sm text-hymid-teal hover:underline">
                  View Details
                </a>
              </div>
            ))}
...
const ProductCatalogue = () => {
  ...
  const products = [
    {
      ...
      description:
        "Precision-molded dashboard components for automotive applications with high heat resistance and durability.",
      image:
    ...
    },
    {
      ...
      description:
        "Sterile, biocompatible housings for medical devices with precise tolerance specifications.",
      image:
        "https://images.unsplash.com/photo-1581595219315-a523f912db8d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      category: "Healthcare",
    ...
    },
    {
      ...
      description:
        "Lightweight, durable shells for various consumer electronics with excellent finish and precise fit.",
      image:
        "https://images.unsplash.com/photo-1558002038-1055907df827?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
    ...
    },
    {
      ...
      description:
        "UV-resistant, weather-durable components for agricultural irrigation systems.",
      image:
        "https://images.unsplash.com/photo-1500673922987-e212871fec22?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
    ...
    },
    {
      ...
      description:
        "Sustainable packaging solutions that minimize environmental impact while maintaining product protection.",
      image:
        "https://images.unsplash.com/photo-1604187351574-c75ca79f5807?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      category: "Packaging",
    ...
    },
    {
      ...
      description:
        "Heavy-duty storage containers for industrial applications with stackable design and reinforced structure.",
      image:
        "https://images.unsplash.com/photo-1633961409991-39546e1376c2?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=500&q=80",
      category: "Industrial",
  ...
  return (
    <div className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative h-[60vh] flex items-center justify-center bg-[#101827] overflow-hidden">
        ...
        <div className="hymid-container flex flex-col items-center text-center relative z-10">
          ...
          <p className="text-lg md:text-xl text-white max-w-3xl mb-10">
            Explore our comprehensive range of precision plastic solutions
      ...
      {/* Digital Brochure */}
      <section id="brochure" className="section-padding bg-[#0f172a]">
        <div className="hymid-container">
          <div className="text-center mb-16">
            ...
            <p className="text-hymid-gray max-w-3xl mx-auto">
              Download our comprehensive product catalog or browse online to
              explore our complete range of plastic manufacturing solutions.
            </p>
          </div>

          <div className="flex flex-col md:flex-row items-center gap-12 ">
            <div className="w-full md:w-1/2 reveal-on-scroll">
              <div className=" bg-[#1e293b] p-8 rounded-lg shadow-lg border border-[#334155] ">
                <div className="aspect-[3/4] rounded-lg shadow-inner flex items-center justify-center overflow-hidden">
                  <Image className="text-hymid-teal opacity-30" />
                </div>
            ...
            <div className="w-full md:w-1/2 reveal-on-scroll">
              <div className="bg-white p-6 rounded-lg shadow-lg">
                <h3 className="text-2xl font-semibold text-hymid-dark mb-6">
                  Product Highlights
                </h3>
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-semibold text-hymid-dark mb-1">
                        Diverse Product Range
                      </h4>
                      <p className="text-hymid-gray text-sm">
                        Explore our extensive collection of plastic products
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-hymid-gray text-sm">
                        Access comprehensive technical specifications, material
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-hymid-gray text-sm">
                        View detailed images showcasing the quality and features
                        of our products.
                      </p>
                    </div>
                  </div>
      ...
      <section id="categories" className="section-padding bg-hymid-light">
        <div className="hymid-container">
          <div className="text-center mb-16">
            ...
            <p className="text-hymid-gray max-w-3xl mx-auto">
              Browse our products by industry category to find the perfect
          ...
          <div className="text-center reveal-on-scroll">
            <p className="text-hymid-gray mb-6">
              Can't find what you're looking for? Contact us for custom product
              development tailored to your specific requirements.
            </p>
            <a
              href="/services"
      ...
      <section className="section-padding bg-white">
        <div className="hymid-container">
          <div className="text-center mb-16">
            ...
            <p className="text-hymid-gray max-w-3xl mx-auto">
              Discover how our products are being utilized across various
              industries to solve complex challenges.
            </p>
          </div>
